...
namespace strange.examples.multiplecontexts.social
{
	public class UserTileView : View
	{
		...
		private IEnumerator loadUserImg()
		{
            ...
            //todo cy
            UnityWebRequest uwrt = UnityWebRequestTexture.GetTexture(imgUrl);
            yield return uwrt.SendWebRequest();
            edx_ImageHolder.GetComponent<Renderer>().material.mainTexture = ((DownloadHandlerTexture)uwrt.downloadHandler).texture;
        }
